...
export function BabyBottleDecor({ className = '' }: { className?: string }) {
  return (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" className={className} aria-hidden="true" role="presentation">
...
export function HeartDecor({ className = '' }: { className?: string }) {
  return (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" className={className} aria-hidden="true" role="presentation">
      <path
...
export function StarDecor({ className = '' }: { className?: string }) {
  return (
    <svg width="14" height="14" viewBox="0 0 14 14" fill="none" className={className} aria-hidden="true" role="presentation">
      <path
...
export function LeafDecor({ className = '' }: { className?: string }) {
  return (
    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" className={className} aria-hidden="true" role="presentation">
      <path
...
export function CloudDecor({ className = '' }: { className?: string }) {
  return (
    <svg width="24" height="16" viewBox="0 0 24 16" fill="none" className={className} aria-hidden="true" role="presentation">
      <path
...
export function SparkleGroup({ className = '' }: { className?: string }) {
  return (
    <svg width="32" height="20" viewBox="0 0 32 20" fill="none" className={className} aria-hidden="true" role="presentation">
